...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (!normalizedEmail.endsWith('@layerup.com.br')) {
      setError('Por enquanto o cadastro está liberado apenas para e-mails @layerup.com.br.')
      setLoading(false)
      return
    }
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Top bar simples com logo e toggle de tema */}
          ...
          <Card className="border border-border bg-card shadow-[0_18px_40px_rgba(15,23,42,0.3)] dark:bg-black/70 backdrop-blur-xl">
            <CardHeader className="space-y-2 pb-2 text-center">
              ...
              <CardDescription className="text-xs leading-relaxed text-muted-foreground">
                Use seu e-mail corporativo da Layer Up para criar seu usuário na plataforma.
              </CardDescription>
            </CardHeader>
